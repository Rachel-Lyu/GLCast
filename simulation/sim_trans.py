...
def run_simulation(n_aux_sites, informative_sites, num_group, group_size, n_list, nval_list, nrep=10, rho=0, s=10, alpha = 1.0, beta_type='EvenOnes', snr=1, h=6, q=20, n_agg = 5, seed=None, results_dir=None):
    ...
    precision_records = {
        ...
        "TransGroupLasso": [],
        "TransSequentialFeatureSelection": []
    }
    recall_records = {
        "GroupLasso": [],
        "GroupKnock": [],
    ...
    while i < nrep:
        ...
        for j in range(N):
            if j == 0: 
                ...
                model_name = 'TransSequentialFeatureSelection'
            data.append({
                'model': model_name,
...
def parse_arguments():
    ...
    parser.add_argument('--num_group', type=int, default=100, help='Number of groups.')
    ...
    parser.add_argument('--nrep', type=int, default=100, help='Number of repetitions.')
